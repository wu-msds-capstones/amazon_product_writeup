...
Finally, we removed the duplicate data using a simple `.drop_duplicates()` method, and dropped any columns that became obsolete through the tidying process. @fig-tidy shows a finalized and joined table that will be utilized for analysis and modeling.

![Cleaned and joined table](images/tidy_data.png){#fig-tidy}